...
export default function Header() {
    ...
    return (
        <Grid container flexDirection={'row'} alignItems={'center'} columns={12} pr={10} pl={10} pt={3} pb={3} mb={6} sx={{
            ...
            <Grid item sm md lg xl xs={12}>
                <Grid container flexDirection={'row'} justifyContent={'flex-end'}>
                    <Button  onClick={() => router.push('/register')} sx={{padding: '1em 2em', fontWeight: 700, 
                    ...
                    <Button onClick={() => router.push('/login')} variant={'text'} sx={{paddingLeft: 6, paddingRight: 6,
